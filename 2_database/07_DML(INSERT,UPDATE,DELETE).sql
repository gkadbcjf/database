...
INSERT INTO EMPLOYEE VALUES(900,'이소근','880914-1456789','SG8809@naver.com','01055554444',
...
/*
    ...
    =>NOT NULL제약조건이 걸려있는 컬럼은 반드시 직접값을 넣어줘야한다.
...
UPDATE EMP_SALARY
SET BONUS =0.3
WHERE DEPT_CODE IN (SELECT DEPT_ID   --EMP_ID 둘다
FROM EMP_SALARY
JOIN DEPARTMENT ON (DEPT_CODE=DEPT_ID)
JOIN LOCATION ON (LOCATION_ID =LOCAL_CODE)
WHERE LOCAL_NAME LIKE 'ASIA%');
...
/*
    ...
    [표현식]
    DELETE FROM 테이블명
    [WHERE 조건] --> WHERE절 재시안하면 전체행 다 삭제됨
*/

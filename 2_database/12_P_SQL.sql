...
/*
    래퍼런스타입변수로 EID,ENAME,JCODE,SAL,DTITLE을 선언하고
...
--      일반타입변수(TEAM 문자열) <== 국내팀, 해외팀 분리해서 담을 예정
--BEGIN
...
/
------------------------실습 ---------------------------
--사용자에게 입력받은 사번의 사원의 급여를 조회해서 SAL변후 대입
--500만원 이상이면 '고급'
--400만원 이상이면 '중급'
--300만원 이상이면 '초급'
--'해당 사원의 급여등급은 XX입니다.

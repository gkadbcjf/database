...
/*
    ...
    *자료형 
    ...
    -숫자(NUMBER)
    -날짜(DATE)
      자바 프로젝트3/5,데이터베이스 공부3/4, 기사자격증 공부3/5            
*/
...
/*
    ...
    ->잘못 작성시 새로 수정하면 된다.
*/
COMMENT ON COLUMN MEMBER.MEM_NO IS '회원내용';
...
--INSERT INTO 테이블명 VALUES(값, 값, 값, 값, 값, 값, 값)
INSERT INTO MEMBER
...
INSERT INTO MEMBER
VALUES(2,'USER2','PASS2','홍킬동',NULL,NULL,NULL,SYSDATE);
...
/*
    *NOT NULL 제약조건
    ...
    제약조건을 부여한 방식은 크게 2가지가 있다. (컬럼레벨방식/ 테이블레벨방식)
...
--의도했던대로 오류가 발생한다.(NOT NULL제약조건에 위배되어 오류 발생)
...
/*
    *UNIQUE제약조건
    ...
    삽입/수정시 기존에 있는 데이터값 중 종복값이 있을 경우 오류를 발생시킨다.
*/
...
INSERT INTO MEM_UNIQUE
VALUES(3, 'USER3', 'PASS3', '김똥', NULL,NULL,NULL);

INSERT INTO MEM_UNIQUE
VALUES(4, 'USER3', 'PASS4', '개똥', NULL,NULL,NULL);
SELECT * FROM MEM_UNIQUE;
-------------------------------------------------------------------------------
...
INSERT INTO MEM_CHECK
VALUES(2, 'USER2', 'PASS1', '홍길똥', '감자',NULL,NULL);
...
/*
    ...
    EX) 회원번호, 학번, 군번, 부서코드, 직급코드, 주문번호, 택배운송장번호, 예약번호등등...
...
--복합키 : 두개의 컬럼을 동시에 하나의 PRIMARYKEY로 지정하는 것
...
INSERT INTO MEM VALUES(1,'USER1','PASS01','홍길똥','여',NULL, NULL,NULL);
INSERT INTO MEM VALUES(2,'USER2','PASS02','홍킬동','남',NULL, NULL,10);
INSERT INTO MEM VALUES(3,'USER3','PASS03','개',NULL,NULL, NULL,10);
INSERT INTO MEM VALUES(4,'USER4','PASS04','고양이',NULL,NULL, NULL,40);
--유효한 회원등급이 아니여도 잘 들어간다.
DROP TABLE MEM;
SELECT * FROM MEM;
--------------------------------------------------------------------------------
/*
    *FOREIGN KEY(외래키) 제약조건
    다른테이블에 존재하는 값만 들어와야되는 특정 컬럼
    -> 다른 테이블을 참조한다고 표현
...
INSERT INTO MEM VALUES(3,'USER3','PASS03','빠끄',NULL,NULL, NULL,40);
--> parent key를 찾을 수 없다는 오류 발생

SELECT * FROM MEM;
--MEM_GRADE(부모테이블) -|------<- MEM(자식테이블)
--       1:N관계 1쪽이 부모테이블 N이 자식테이블
INSERT INTO MEM VALUES(3,'USER3','PASS03','김빠끄','여',NULL, NULL,20);
INSERT INTO MEM VALUES(4,'USER4','PASS04','쓰껄','남',NULL, NULL,10);

--> 이때 부모테이블에서 데이터값을 삭제하면 어떻게 될까?
--데이터 삭제 : DELETE FROM 테이블명 WHERE 조건;

--MEM_GRADE테이블에서 10번등급 삭제
...
-->부모테이블로 부터 무조건 삭제가 안되는 "삭제제한"옵션이 걸려있다.
...
INSERT INTO MEMBER VALUES(3,'가보자',17,DEFAULT,DEFAULT);

SELECT * FROM MEMBER;

--INSERT INTO MEMBER(컬럼1, 컬럼2 ... ) VALUES(컬럼1값, 컬럼2값...);
INSERT INTO MEMBER(MEM_ID,MEM_NAME) VALUES(4,'이광인');
...
/*
    *테이블이 다 생성된 후에 뒤늦게 제약조건을 추가하는 방법
    ...
    -FOREIGN KEY : ALTER TABLE 테이블명 ADD FOREIGN KEY(컬럼명) REFERENCES 참조할 테이블명 [(참조할 컬러몀)]
    -UNIQUE      : ALTER TABLE 테이블명 ADD UNIQUE(컬럼명);
    -CHECK       : ALTER TABLE 테이블명 ADD CHECK(컬럼에 대한 조건식);
    -NOT NULL    : ALTER TABLE 테이블명 MODIFY 컬럼명 NOT NULL;
*/

--EMPLOYEE COPY테이블에 PRIMARY_KEY 제약조건을 추가(EMP_ID)
ALTER TABLE EMPLOYE_COPY ADD PRIMARY KEY(EMP_ID);
--EMPLOYE_COPY테이블에 DEPT_CODE에 외래키 제약조건 추가
ALTER TABLE EMPLOYEE ADD FOREIGN KEY(DEPT_CODE) REFERENCES DEPARTMENT;              
--EMPLOYE_COPY테이블에 JOB_CODE에 외래키 제약조건 추가
